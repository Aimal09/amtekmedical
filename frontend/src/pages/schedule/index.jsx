...
const ScheduleDetails = () => {
  ...
  const appoinmentForm = async () => {
    ...
    try {
      ...
      if (savedata?.success) {
        ...
        alert("Submission failed: " + (savedata?.message || "Unknown error"));
      }
      console.log("Response from API:", savedata);
    } catch (error) {
      console.error("Error while saving data:", error);
    }
     // i want to open again this file on save button click
    window.location.reload();
    // if i want to relocated on calendar page from windows properties  
      ...
      <div className="card p-4 shadow-lg">
        <div className="row">
          <div className="col-md-4">
            ...
            <p className="fs-5">
              <strong>HealthProblem :</strong>{" "}
              {appoinment.healthProblem ? "Yes" : "No"}
            </p>
            <p className="fs-5">
              <strong>BloodPresure:</strong>{" "}
              {appoinment.bloodPresure ? "Yes" : "No"}
            </p>
            <p className="fs-5">
              <strong>AllergyProblems:</strong>{" "}
              {appoinment.allergyProblems ? "Yes" : "No"}
            </p>
            <p className="fs-5">
              <strong>ThyroidProblems:</strong>{" "}
          ...
          <div className="col-md-8">
            <div className="p-3 slide-in-container">
              ...
              <div className="mt-3">
                ...
                <ComboBox
                  data={diagnosisOptions.map((d) => ({
                    value: d.Id,
                    label: d.Title,
                  }))}
                  onSelect={setDoctorDiagnosis}
                />
              </div>
              <button
                type="button"
  ...
  `}
                      ...
                      <div className="buttons my-3 d-flex">
                        ...
                        <button className="butn-sec" onClick={handleBack}>
                          Back
                        </button>
                      </div>
                    </>
              ...
              <div className="modal-dialog">
                <div className="modal-content">
                  ...
                  <div className="modal-body">
                    <p>
                      <strong>Date of Visit:</strong> {selectedVisit.CreatedOn}
                    </p>
                    <p>
                    ...
                    <p>
                      <strong>Patient Name:</strong> {selectedVisit.PatientName}
                    </p>
                    <p>
                    ...
                    <p>
                      <strong>Doctor Diagnosis:</strong>{" "}
                      {selectedVisit.doctorDiagnosis}
                    </p>
                    <p>
