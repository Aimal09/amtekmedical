...
export default function EditPatient() {
  ...
  const [emergencyPhone, setEmergencyPhone] = useState(patientData.EmergencyPhone);
  ...
  const [allergyProblems, setAllergyProblems] = useState(patientData.allergyProblems);
  const [thyroidProblems, setThyroidProblems] = useState(patientData.thyroidProblems);
  ...
  const [initialStatement,setInitialStatement] = useState(patientData.InitialStatement);
  const [painScale, setPainScale] = useState(patientData.PainScale);
  ...
  const saveForm = async () => {
      ...
      const payload = {
          ...
          asthama, anyOther, medication, pregnant, painScale: painMessages[painScale], initialStatement, passportNo, emiratesNo,patientID
      };
